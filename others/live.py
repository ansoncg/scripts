...
response = requests.get(
    "https://api.twitch.tv/helix/streams/followed?user_id=52363379", headers=headers
).json()
moon = requests.get(
    "https://api.twitch.tv/helix/channels?broadcaster_id=121059319", headers=headers
).json()
data = response["data"]
