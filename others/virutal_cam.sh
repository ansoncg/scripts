...
Stream com som:
streamlink --stdout https://www.twitch.tv/esl_csgo best | ffmpeg -stream_loop 3000 -re -i pipe:0 -map 0:v -f v4l2 /dev/video3 -f s16le -ar 44100 -ac 1 - > /tmp/vmic

Video com som yt-dlp:
yt-dlp "https://www.youtube.com/watch?v=JcXjbY7IX7I" -o - | ffmpeg -stream_loop 3000 -re -i pipe:0 -map 0:v -f v4l2 /dev/video3 -f s16le -ar 44100 -ac 1 - > /tmp/vmic
